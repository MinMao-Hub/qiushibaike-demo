...
@implementation OtherViewSContent
...
- (void)viewDidLoad
{
    webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 64, kScreemWidth, kScreemHeight-64)];
...
- (void)setNavBar
{
    ...
    myNavBar.image = [UIImage imageNamed:@"musics_nav_bg"];
