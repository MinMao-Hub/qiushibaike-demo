...
- (void)viewDidLoad
{
    ...
    statusbar.image = [UIImage imageNamed:@"photos_nav_bg"];
...
- (void)setWebView
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://m.baidu.com/img?tn=bdidxiphone&itj=41&ssid=0&from=1009502a&uid=&pu=sz%401kScreemWidth_1001%2Cta%40iphone_2_4.2_3_534&bd_page_type=1"];
